...
\begin{landscape} % Begin landscape mode
	\begin{tikzpicture}[x=1cm, y=1cm, every node/.style={font=\small}]
		...
		\node[timeline below] at (8,0) {25/4: Results for Baseline models and its documentation};
		...
		\node[timeline below] at (12,0) {15/5: SIRUS extraction and its documentation};
